...
| Metric | Value |
| --- | --- |
| avg_wasserstein | 0.0865 |
| avg_jsd | 0.0888 |
| correlation_frobenius | 0.1429 |

**Numerical:** 4 columns, avg Wasserstein=0.0865, avg JSD=0.0888, KS pass rate (p>0.05)=100%
